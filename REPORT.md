...
| **MCP Browser Tools** (AgentDeskAI/browser-tools-mcp) | Проверка работоспособности фронтенда в реальном Chrome: скриншоты, console/network логи, аудит доступности |
