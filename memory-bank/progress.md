...
## Текущий статус
**M7: Frontend — дашборд и детальные страницы** завершён. Добавлены графики Chart.js на дашборд, профили игроков, детали турниров. 20/20 тестов проходят, docker build успешен.
